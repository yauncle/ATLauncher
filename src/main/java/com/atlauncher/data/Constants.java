...
//    public static final String DISCORD_CLIENT_ID = "589393213723246592";
    public static final String DISCORD_CLIENT_ID = "none";
//    public static final String GA_TRACKING_ID = "UA-88820616-7";
    public static final String GA_TRACKING_ID = "none";
//    public static final String CROWDIN_URL = "https://crowdin.com/project/atlauncher";
    public static final String CROWDIN_URL = "https://minecraft.yauncle.net/";
    ...
    public static final String DOWNLOAD_SERVER = "https://files.minecraft.yauncle.net/hoshicraft/atl";
//    public static final String DOWNLOAD_HOST = "download.nodecdn.net";
    public static final String DOWNLOAD_HOST = "files.minecraft.yauncle.net";
